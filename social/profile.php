...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="Fakehub"><b>Fakehub</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
				...
				<li><a href="profile.php" title="Profile"><label class="active">your profile</label></a></li>
				<li><a href="photos.php" title="Settings"><label>your pics</label></a></li>
	...
	<div id="container">
		...
		<div id="left-nav">
				...
				<div class="clip1">
				<a href="updatephoto.php" title="Change Profile Picture"><img src="<?php echo $row['profile_picture'] ?>"><button>Change Picture</button></a>
