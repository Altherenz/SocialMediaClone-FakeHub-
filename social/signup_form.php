...
<?php
	...
	if (isset($_POST['submit']))
	{
		...
		{
			mySQLi_query($con,"INSERT INTO user (firstname,lastname,username,username2,birthday,gender,number,email,email2,password,password2,profile_picture,cover_picture)
