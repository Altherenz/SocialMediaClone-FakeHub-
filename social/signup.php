...
<html>
	...
	<head>
		<title>Welcome  To Fakehub - Sign up, Log in, Post </title>
...
<body>
	...
	<div id="container">
		...
		<center>	
			<h1>Welcome to Fakehub</h1>
		</center>

			<h2>Sign up</h2>
			<b>Fill up everything.</b>
		<br />
		...
		<fieldset class="sign-up-form-1">
			...
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					...
					<td><input type="text" name="number" placeholder="050...." maxlength="13" class="form-1" title="Enter your mobile number" required /></td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset class="sign-up-form-1">
			...
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					<td><input type="text" name="email" placeholder="Enter your email....." class="form-1" title="Enter your firstname" required /></td>
		...
		<br />
			...
			<strong>Yes, I have read and I accept the <a href="#">Fakehub Terms of Use</a> and the <a href="#">Fakehub Privacy Statement</a></strong>
			
		<br />
		<br />
					<input type="submit" name="submit" value="Agree and Continue" class="btn-sign-in" title="Log in" />
		</form>
