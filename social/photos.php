	...
	<div id="header">
		<div class="head-view">
			<ul>
				...
				<li><a href="profile.php" title="Profile"><label>your profile</label></a></li>
				<li><a href="photos.php" title="Settings"><label class="active">your pics</label></a></li>
